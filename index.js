...
─██████████████──██████████──██████████████──██████████████──██████──────────██████──────██████──────██████████████──██████████████──────██████──────██████████████──██████──██████████─ 
──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── 
created by Cheboi_M-net🕵
contact me 254726544530♻️
© Copy coder alert ⚠
*/
...
const ownerNumber = [254726544530']
...
*╭⊱✫🔮 SILENT-SOBX-MD 🔮✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *M-NET-TECH-MD*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *CHEBOI LOVER⁴³²*
*│✫➠ - 🌐URL:* *https://github.com/Cheboimnetk*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://ibb.co/StFF4Dd` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes(254726544530")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("254729527325")){
if(isReact) return
m.react("👑")
}
...
app.get("/", (req, res) => {
res.send("HEY,M-NET-TECH-MD STARTED ✅");
});
